...
class NotInterstedPostPage extends StatefulWidget {
  final String accType;
  const NotInterstedPostPage({super.key, required this.accType});

  @override
  State<NotInterstedPostPage> createState() => _NotInterstedPostPageState();
}

class _NotInterstedPostPageState extends State<NotInterstedPostPage> {
